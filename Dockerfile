...
ADD http://dev.xif.fr:7979/catlist/catlist-2017-01-11.zip /
RUN unzip /catlist-2017-01-11.zip -d /var/www/lib/plugins/ && rm /catlist-2017-01-11.zip
ADD https://codeload.github.com/gturri/nspages/legacy.zip/master /plugins/
RUN unzip /plugins/* -d /var/www/lib/plugins/ && rm -r /plugins
